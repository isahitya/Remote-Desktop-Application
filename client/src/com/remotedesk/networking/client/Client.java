...
private BufferedImage onCanvas;
...
//System.out.println(RemoteWidth+","+RemoteHeight);
...
{
Client c=new Client(aa[0],Integer.parseInt(aa[1]),Integer.parseInt(aa[2]));
}*/
